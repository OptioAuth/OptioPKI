...
#
# Company: OptioAuth
# Name: CreateClientCSR.sh
# Purpose: Create the client key (client.key.pem). 
# Author: Jay Mayers optioauth@gmail
#
##################################################################
#
SAN1="DNS:www.optioauth.io"
SAN2="DNS:www.aoptioauth.com"
...
openssl genrsa -aes256 -out client/private/client.key.pem 4096

chmod 400 client/private/client.key.pem

openssl req -config client/client_openssl.cnf -new -sha256 -key client/private/client.key.pem  -out client/csr/client.csr.pem 
# openssl req -config client/client_openssl.cnf -new -sha256 -key client/private/client.key.pem  -out client/csr/client.csr.pem -addext "subjectAltName = ${SAN}"
