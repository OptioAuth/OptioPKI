...
#
# Company: OptioAuth
# Name: PrepareServerDir.sh
# Purpose: Create the Server ENV 
...
# in intermediate/openssl.cnf file and reference it in server_cert section.
#
##################################################################
# 
cd ${BASE_DIR}
...
cp ${BASE_DIR}/cnf/server_openssl.cnf ${BASE_DIR}/server
# 
##################################################################
# In this example, the server folder resides inside /root/ca. That is just for convenience, 
# furthermore, this is to be considered a bad practice to be in the same location and system 
# The root CA and server CA should be on different machines.
# 
...
# 
echo 1000 > ${BASE_DIR}/server/crlnumber
